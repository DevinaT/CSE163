def main():
    ...
    tabacco_df = tabacco_df[['YEAR', 'LocationAbbr', 'TopicDesc', 'MeasureDesc',
                         'Data_Value', 'Gender', 'Race', 'Age', 'Education']]
    ...
    obesity_filtered = obesity_df.loc[is_state, ["Year", "Locationabbr", "Response", "Break_Out", "Data_value"]]
